...
- **Certificate reuse** — reuses a team certificate when this Mac already holds the private key; never auto-revokes
...
- **No Xcode project or IDE runtime** — the helper talks to Apple's services directly

## Installation

**Requirements:** macOS 12+. The release bundle carries the OpenSSL runtime libraries used by the helper.
